...
def config():
    ...
    parser.add_argument("--resume_model_path",type=str,required=False)
    ...
    parser.add_argument("--dev_name",default="dev.json",type=str,required=False)##无效配置
    ...
    parser.add_argument("--out_dir",type=str,default="./out/ner_out/")
